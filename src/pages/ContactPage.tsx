            ...
            <div className="max-w-4xl mx-auto bg-white p-8 shadow-xl rounded-lg space-y-8">
                ...
                <section>
                    ...
                    <div className="mt-4 flex flex-col gap-4">
                        {/* Téléphone */}
                        <div
                            className="flex flex-col sm:flex-row sm:items-center sm:justify-start gap-3 sm:gap-4 p-4 bg-gray-50 rounded-lg">
                            <div
                                className="flex-shrink-0 w-12 h-12 bg-gray-800 rounded-lg flex items-center justify-center mx-auto sm:mx-0">
                ...
                <section>
                    ...
                    <p className="mt-2 text-gray-600">
                        Suivez-moi sur les réseaux sociaux pour découvrir mes derniers projets et rester informé de mes
                        activités.
                    </p>
                    <div className="mt-6 flex justify-center space-x-8">
                        ...
                        >
                            <div
                                className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mb-3 group-hover:bg-blue-700 transition-colors duration-300">
                            ...
                            <span
                                className="text-lg font-semibold text-blue-600 group-hover:text-blue-700">LinkedIn</span>
                        </a>
                        ...
                        >
                            <div
                                className="w-16 h-16 bg-gray-800 rounded-full flex items-center justify-center mb-3 group-hover:bg-gray-900 transition-colors duration-300">
                                <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                            ...
                            <span
                                className="text-lg font-semibold text-gray-600 group-hover:text-gray-800">GitHub</span>
                        </a>
                    </div>
                </section>
                ...
                <div className="mt-6 flex flex-col sm:flex-row justify-center items-center gap-4">
                    ...
                    <a
                        ...
                        className="inline-flex items-center space-x-2 px-4 py-2 sm:px-5 sm:py-3 bg-gray-800 text-white text-sm sm:text-base font-medium rounded-lg shadow-md hover:bg-gray-700 transition-colors"
                    >
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center space-x-2 px-4 py-2 sm:px-5 sm:py-3 bg-blue-600 text-white text-sm sm:text-base font-medium rounded-lg shadow-md hover:bg-blue-700 transition-colors"
                    >
                        <div className="flex items-center justify-center">
                            <svg className="w-5 h-5 text-white mr-1" fill="none" stroke="currentColor"
                                 viewBox="0 0 24 24">
